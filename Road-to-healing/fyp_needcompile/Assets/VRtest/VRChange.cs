...
public class VRChange : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!String.Equals(prevStr, tempStr) || input.action.WasPressedThisFrame())
        {
            ...
            if (!String.Equals(curStatus.Substring(0, 7), prevStatus.Substring(0, 7)) || input.action.WasPressedThisFrame())
            {
            ...
            switch (currExerciseType)
            {
                case ExerciseType.ANKLE_PUMP:
                    ...
                    if (gameType == 1)
                    {
                        ...
                        Debug.Log(input.action.WasPressedThisFrame());

                        if (message.IndexOf("Awesome") != -1 || input.action.WasPressedThisFrame())//Reach the ankle raising position
                    ...
                    //2nd Game Type: --> Cross Belows
                    if (gameType == 2)
                    {
                        if (message.IndexOf("Congratulation") != -1 || input.action.WasPressedThisFrame())//Reach the ankle raising position 10s and release
                        { //Revise with reach the position
                          //     Debug.Log("A ");
                            locamotion.SetActive(false);
                            alongPointMove.enabled = true;
                ...
                case ExerciseType.ANKLE_ROTATION:
                    ...
                    if (gameType == 3)
                    {
                        if (message.IndexOf("Outward") != -1 || input.action.WasPressedThisFrame())
                        { //Revise with reach the position
                          //     Debug.Log("A ");
                            locamotion.SetActive(false);
                            alongPointMove.enabled = true;
                        ...
                        else if (message.IndexOf("Inward") != -1 || input.action.WasPressedThisFrame())
                        {
                            locamotion.SetActive(false);
                            alongPointMove.enabled = true;
